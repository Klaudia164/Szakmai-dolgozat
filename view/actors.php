...
if(!isset($_REQUEST["actorsId"])){
    ...
    <div style='background-image: url(images/<?= $actors -> get_hatter() ?>);background-repeat: no-repeat; background-attachment: scroll; background-size: cover; height: 70em; margin-top: 0;'>
